...
public class GameModel implements Cloneable{
     ...
     */
    private int[][] model;
//    private int[][] model1 = (int[][]) model.clone();

   /**
     * The current position of the blue dot
     */
    private Point currentDot;
//    private Point currentDot1 = (Point) currentDot.clone();
...
//    }
    ...
    /**
     * returns the current status of clone (AVAILABLE, SELECTED or DOT) of a given dot in the game
     * 
     * @param i
     *            the x coordinate of the dot
     * @param j
     ...
     * @return the status of the dot at location (i,j)
     */   
//    public int getCurrentStatus1(int i, int j){
//        return model1[i][j];
//    }
...
//      clone.currentDot1= currentDot.clone();
//      clone.model1=model.clone();
//      return clone;
